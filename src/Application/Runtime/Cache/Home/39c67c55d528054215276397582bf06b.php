...
<ul class="licai edit-ul" style="display:block">
  ...
  <li>
   ...
   ￥<input type="text" name="aim" id="url" value="<?php echo ($show["cn_aim"]); ?>" />
  ...
  <li>
   ...
   ￥<input type="text" name="reality" id="url" value="<?php echo ($show["cn_reality"]); ?>" />
  ...
  <li>
   ...
   <input type="text" name="explain" id="earnings" value="<?php echo ($show["cn_explain"]); ?>" />
