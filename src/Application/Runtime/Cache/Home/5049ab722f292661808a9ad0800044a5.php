...
<div class="title">推广业务汇总数据展示</div>
...
<div>
  ...
  <a href="<?php echo U('ad');?>?num=1">每日收益汇总</a>&nbsp;&nbsp;

  <a href="<?php echo U('ad');?>?num=2">每周收益汇总</a>&nbsp;&nbsp;
...
<img src="<?php echo U('drawXian');?>" alt="">
...
<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php if(!isset($val['ex_aim'])){continue;} ?>

  <tr class="first">

    <td align="center"><?php echo ($val["date"]); ?></td>

    <td align="center">￥<?php echo ($val["ex_aim"]); ?></td>

    <td align="center">￥<?php echo ($val["ex_reality"]); ?></td>

    <td align="center"><?php echo ($val["ex_explain"]); ?></td>

    <td align="center"><a class="ebit" href="<?php echo U('edit',array('id'=>$val['id'],'num'=>1));?>" onClick="return confirm('确定要修改吗？')">修改</a></td>
