...
<ul class="licai edit-ul" style="display:block">
  ...
  <li>
   ...
   ￥<input type="text" name="aim" id="url" value="<?php echo ($show["aim"]); ?>" />
  ...
  <li>
   ...
   ￥<input type="text" name="reality" id="url" value="<?php echo ($show["reality"]); ?>" />
  ...
  <li>
   ...
   <input type="text" name="explain" id="earnings" value="<?php echo ($show["explain"]); ?>" />
  ...
  <li>
    ...
    <input type="hidden" name="gid" value="<?php echo ($show["gid"]); ?>">
